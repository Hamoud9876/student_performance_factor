...
def dim_peer_influance(file_df: pd.DataFrame) -> pd.DataFrame:
    """
    transform the peer influance column from in the dataset to
    ...
    try:
        ...
        pi_df["peer_influance"] = copy_df["Peer_Influence"].unique()
    except Exception as e:
        logging.error("error while transforming unique peer influance")
        return None
